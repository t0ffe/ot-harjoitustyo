...
keywords_all = set.union(keywords_help, keywords_input, keywords_quit,
                         keywords_generate, keywords_validate, keywords_browse)
    ...
    def fancy_input():
        ...
        while True:
            ...
            if input_text not in keywords_all:
                print(
                    "Sorry, but that isn't a valid input. Please enter a valid input or type help to see all the valid commands.")
            ...
            if input_text in keywords_validate:
                ...
                password = input(
                    "Type your password to see if it's strong! \n")
